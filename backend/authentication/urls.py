...
urlpatterns = [
    ...
    # path("put_calculate_credits_earned/<int:user_id>/", views.put_calculate_credits_earned),
    # path('put_calculate_gpa/<int:user_id>/', views.put_calculate_gpa),
    path("individual_graduation_eligibility/<int:user_id>/", views.put_individual_graduation_eligibility),
